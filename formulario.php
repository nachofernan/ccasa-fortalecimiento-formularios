...
if(!isset($_GET['formulario']) || $_GET['formulario'] == null) {
    header("Location: listado.php");
    die();
} else {
...
<div class="container my-4 py-4">
    ...
    <a href="personal.php?id=<?php echo $personal['id']; ?>" class="btn btn-secondary btn-sm px-5 mr-3">Volver</a>
    <?php
...
<div class="row border-bottom pb-3">
    <div class="col-8 offset-1">
        ...
        <div class="row py-2">
            ...
            <div class="col">
                <input type="text" name="nombre" id="nombre" class="form-control disabled" disabled required value="<?php echo $formulario['nombre']; ?>">
            </div>
        </div>
        <div class="row py-2">
            <div class="col">
            ...
            <div class="col">
                <input type="text" name="apellido" id="apellido" class="form-control" disabled required value="<?php echo $formulario['apellido']; ?>">
            </div>
        </div>
        <div class="row py-2">
            <div class="col">
        ...
        <div class="row py-2">
            ...
            <div class="col">
                <input type="text" name="cuit" id="cuit" class="form-control" disabled required value="<?php echo $formulario['cuit']; ?>">
            </div>
        </div>
        <div class="row py-2">
            <div class="col">
